...
public class RandomIncrementDoubleType extends TypeHandler {
    public static final String TYPE_NAME = "randomIncrementDouble";
    public static final String TYPE_DISPLAY_NAME = "Random Increment Double";
    ...
    public RandomIncrementDoubleType(){
